...
#
# Caso inválido:
# Se intenta iniciar el Servicio Social antes de confirmar el estado ACTIVO.
#
# Resultado esperado:
...
echo "DOC_VALIDADO"
echo "      ↓"
echo "SS_EN_CURSO (Caso inválido)"
echo
...
# ------------------------------------------------------------------------------
# ETAPA 2: Intento inválido de Servicio Social
# ------------------------------------------------------------------------------

echo
echo "========== ETAPA 2: Validación de transición =========="

echo "CU-04 Iniciar Servicio Social (debe fallar)"
echo "El expediente se encuentra en DOC_VALIDADO, no en ACTIVO."
...
if [ $RESULTADO -eq 0 ]; then
    ...
    echo "La transición DOC_VALIDADO → SS_EN_CURSO no está permitida."
fi
