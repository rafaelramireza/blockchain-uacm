...
# ============================================================
# OPERACIÓN 04 - EMITIR CERTIFICADO
#
# Ejecuta únicamente:
#
# EmitirCertificado()
...
#
# Ejemplo:
#   ./04_emitir_certificado.sh 13-011-1261
#
# ============================================================
...
echo
echo "============================================================"
echo "OPERACIÓN 04 - EMITIR CERTIFICADO"
echo "============================================================"
echo
echo "Matrícula: $MATRICULA"
echo
echo "Operación:"
echo "    EmitirCertificado()"
echo
...
# ------------------------------------------------------------
# Configurar identidad de Certificación
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Ejecutar EmitirCertificado()
# ------------------------------------------------------------

echo "Ejecutando EmitirCertificado()..."

HASH="$(generar_hash "CERTIFICADO_EMITIDO")"

invocar "EmitirCertificado" "$HASH"

echo
echo "EmitirCertificado() ejecutada correctamente."
echo
...
echo "============================================================"
echo
echo "Estado esperado: CERTIFICADO"
echo