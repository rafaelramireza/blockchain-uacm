...
#     TITULADO
#
# Condiciones previas del MED-EC:
#
#   CERTIFICADO
#   +
#   SS_LIBERADO
...
#
# Ejemplo:
#   ./07_emitir_titulo.sh 13-011-1261
#
# ============================================================
...
echo
echo "============================================================"
echo "OPERACIÓN 07 - EMITIR TÍTULO"
echo "============================================================"
echo
...
# ------------------------------------------------------------
# Configurar identidad de Titulación
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Ejecutar EmitirTitulo()
# ------------------------------------------------------------

echo "Ejecutando EmitirTitulo()..."

HASH="$(generar_hash "TITULO_EMITIDO")"

invocar "EmitirTitulo" "$HASH"

echo
echo "EmitirTitulo() ejecutada correctamente."
echo
