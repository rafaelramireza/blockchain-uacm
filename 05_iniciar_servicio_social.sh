...
# ============================================================
# OPERACIÓN 05 - INICIAR SERVICIO SOCIAL
#
# Ejecuta únicamente:
#
...
#
# Ejemplo:
#   ./05_iniciar_servicio_social.sh 13-011-1261
#
# ============================================================
...
echo
echo "============================================================"
echo "OPERACIÓN 05 - INICIAR SERVICIO SOCIAL"
echo "============================================================"
echo
echo "Matrícula: $MATRICULA"
echo
echo "Operación:"
echo "    IniciarServicioSocial()"
echo
...
# ------------------------------------------------------------
# Ejecutar IniciarServicioSocial()
# ------------------------------------------------------------

echo "Ejecutando IniciarServicioSocial()..."

HASH="$(generar_hash "SERVICIO_SOCIAL_INICIADO")"

invocar "IniciarServicioSocial" "$HASH"

echo
echo "IniciarServicioSocial() ejecutada correctamente."
echo
...
echo "============================================================"
echo
echo "Estado esperado: SS_EN_CURSO"
echo