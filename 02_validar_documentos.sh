...
# ============================================================
# OPERACIÓN 02 - VALIDAR DOCUMENTOS
#
# Ejecuta únicamente:
#
# ValidarDocumentos()
...
#
# Ejemplo:
#   ./02_validar_documentos.sh 13-011-1261
#
# ============================================================
...
echo
echo "============================================================"
echo "OPERACIÓN 02 - VALIDAR DOCUMENTOS"
echo "============================================================"
echo
echo "Matrícula: $MATRICULA"
echo
echo "Operación:"
echo "    ValidarDocumentos()"
echo
...
# ------------------------------------------------------------
# Ejecutar ValidarDocumentos()
# ------------------------------------------------------------

echo "Ejecutando ValidarDocumentos()..."

HASH="$(generar_hash "VALIDACION_DOCUMENTAL")"

invocar "ValidarDocumentos" "$HASH"

echo
echo "ValidarDocumentos() ejecutada correctamente."
echo
...
echo "============================================================"
echo
echo "Estado esperado: DOC_VALIDADO"
echo