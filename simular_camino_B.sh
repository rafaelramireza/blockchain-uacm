...
if [ $# -ne 1 ]; then
    echo
    echo "Uso:"
    echo "    ./simular_camino_B.sh <MATRICULA>"

    echo
    echo "Ejemplo:"
    echo "    ./simular_camino_B.sh 11-011-0654"
    echo
    exit 1
fi
...
echo "================================================================================"
echo "Simulación MED-EC - Camino B: INSCRITO
      ↓
...
#------------------------------------------------------------------------------
# Evidencias criptográficas (Off-Chain)
#------------------------------------------------------------------------------
...
echo
echo "========== ETAPA 2: Confirmación del egreso =========="
