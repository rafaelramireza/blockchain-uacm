...
# Flujo:
# INSCRITO → DOC_VALIDADO → ACTIVO → SS_EN_CURSO
# → SS_LIBERADO → CERTIFICADO → TITULADO
# ================================================================================

set -e

if [ $# -ne 1 ]; then
    echo "Uso: ./simular_camino_B.sh <MATRICULA>"
    exit 1
fi
...
echo "================================================================================"
echo "Simulación MED-EC - Camino B"
echo "INSCRITO → DOC_VALIDADO → ACTIVO → SS_EN_CURSO → SS_LIBERADO → CERTIFICADO → TITULADO"
