...
#
# Caso inválido:
# Se intenta emitir el certificado antes de confirmar el estado ACTIVO.
#
# Resultado esperado:
...
# ------------------------------------------------------------------------------
# ETAPA 2: Intento inválido de certificación
# ------------------------------------------------------------------------------
...
if [ $RESULTADO -eq 0 ]; then
    ...
    echo "La transición DOC_VALIDADO → CERTIFICADO no está permitida."
fi
